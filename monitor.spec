...
datas = [('app.py', '.'), ('cli.py', '.'), ('collectors', 'collectors'), ('Monitor.ps1', '.'), ('start_monitor.bat', '.'), ('config.py', '.'), ('data_loader.py', '.'), ('parsers.py', '.'), ('excel_exporter.py', '.'), ('dashboards', 'dashboards'), ('site', 'site')]
