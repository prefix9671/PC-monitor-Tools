...
5. PowerShell에서 한글 문서를 읽을 때는 `Get-Content -Encoding UTF8`를 기본값처럼 사용합니다.
...
|---|---|---|---|
| [Current Phase/CurrentPhase.md](Current%20Phase/CurrentPhase.md) | Current Phase | 현재 개발 단계, 활성 리스크, 운영 기준 | 현재 목표, 리스크, 운영 기준이 바뀔 때 |
| [Current Phase/VerificationChecklist.md](Current%20Phase/VerificationChecklist.md) | Current Phase | 비사소한 코드 변경의 기본 검증 문서 | 테스트 절차나 필수 검증이 바뀔 때 |
...
| [Best Practices/DocumentationWorkflow.md](Best%20Practices/DocumentationWorkflow.md) | Best Practices | 문서-코드 매핑과 ActiveDocs 운영의 기준 문서 | 문서 운영 정책이 바뀔 때 |
